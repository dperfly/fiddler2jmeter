...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cmd_result.setGeometry(QtCore.QRect(10, 220, 781, 251))
        ...
        self.select_input_textEdit.setGeometry(QtCore.QRect(130, 10, 551, 31))
        ...
        self.select_output_textEdit.setGeometry(QtCore.QRect(130, 60, 551, 31))
        ...
        self.host_name_textEdit.setGeometry(QtCore.QRect(160, 120, 521, 31))
        self.host_name_textEdit.setObjectName("host_name_textEdit")
        self.filter_url_textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.filter_url_textEdit.setGeometry(QtCore.QRect(160, 160, 521, 31))
        ...
        self.line_2.setGeometry(QtCore.QRect(0, 200, 801, 16))
        ...
        self.host_name_textEdit.setText(R"^baidu\.com$")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow",
                                        "<html><head/><body><p><span style=\" font-size:10pt;\">* 需要导入的文件</span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow",
                                        "<html><head/><body><p><span style=\" font-size:10pt;\">* 需要导出的文件</span></p></body></html>"))
