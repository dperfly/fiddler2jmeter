    ...
    */
    ...
    function Fiddler2Jmx(oSessions: Fiddler.Session[]){
        ...
        for (var x = 0; x < oSessions.Length; x++){
            ...
            request_escape_list = request_escape_list + " " + escape(session.oRequest.headers+session.GetRequestBodyAsString())
        }
        JsExecCmd(fiddler2jmeter_cmd +" "+ request_escape_list);

    }

    //run script
    static function JsExecCmd(value) {
...
*/
    ...
    */
    ...
    static function Main() {
        ...
        // add ip row
        UI.lvSessions.AddBoundColumn("ServerIP",120,"X-HostIP");
    ...
    static function OnExecAction(sParams: String[]): Boolean {
        ...
        // ---------------------------- 过滤 ----------------------------
        // 过滤选择 response Content-Type header中包含的字符
        // select image
        // select css
        // select htm
        ...
        // ---------------------------- 替换 ----------------------------
        // urlreplace 用不同的字符串替换 URL 中的任何字符串
        // urlreplace SeekStr ReplaceWithStr
        // urlreplace eapit.ibrolive eapit
        // urlreplace        <-- Call with no parameters to clear

        // ------------------------- 断点调试 ---------------------------
        // bpafter 对匹配的请求打 after response 断点
        // bpafter /favicon.ico
        // bpafter        <-- Call with no parameter to clear

        // bps
        // bps statuscode  -> bps 404
        // bps 取消

        // bpv or bpm 对 指定method 的请求打before requset断点
        // bpv POST
        // bpv 取消

        // bpu 为包含指定字符串的 URI 创建请求断点  ★★★★★★★★★
        // bpu /sys/user/captch
